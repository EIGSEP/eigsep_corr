...
class CorrConfig:
    ...
    fpg_file : str = str((Path(DATA_PATH) / "eigsep_fengine_1g_v2_3_2024-07-08_1858.fpg").resolve())
    ...
    pam_atten : dict[int, tuple[int, int]] = {0: (8, 8), 1: (8, 8), 2: (8, 8)}
    pol_delay : dict[str, int] = {"01": 0, "23": 0, "45": 0}
    nchan : int = 1024
